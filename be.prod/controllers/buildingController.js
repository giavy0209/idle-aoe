...
var buildingController = /** @class */ (function () {
    ...
    buildingController.get = function (req, res) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        findCastle = _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, models_1.Buildings.find({ user: _id, castle: findCastle === null || findCastle === void 0 ? void 0 : findCastle._id })
