...
var resourceController = /** @class */ (function () {
    ...
    resourceController.get = function (req, res) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        findCastle = _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, models_1.Resources.find({ user: _id, castle: findCastle === null || findCastle === void 0 ? void 0 : findCastle._id })
                            .populate('type')];
                    case 5:
                        data = _a.sent();
