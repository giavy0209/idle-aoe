...
var battleController = /** @class */ (function () {
    ...
    battleController.get = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _id, page, skip, query, data, total;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, models_1.Battles.find(query)
                    ...
                    case 1:
                        data = _a.sent();
                        return [4 /*yield*/, models_1.Battles.countDocuments(query)];
                    case 2:
                        total = _a.sent();
