...
var trainningController = /** @class */ (function () {
    ...
    trainningController.post = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _id, _a, unit, total, castle, isTranning, user, unitData, baseCost, costs, key, _resource, userResource, isEnoughResource, building, dereaseTime, unitTrainingTime, time, finishAt, userUnit, resourceUsed, index, resource, name_1;
                ...
                switch (_b.label) {
                    ...
                    case 7:
                        ...
                        for (index = 0; index < userResource.length; index++) {
                            ...
                            name_1 = resource.type.name.toLowerCase();
                            workerChangeResource_1.CHANGE_RESOURCE.push({
                                resource: resource._id,
                                newValue: -costs[name_1]
                            });
                            resourceUsed += costs[name_1];
                        }
