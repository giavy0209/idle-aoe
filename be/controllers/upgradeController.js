...
var upgradeController = /** @class */ (function () {
    ...
    upgradeController.post = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _id, building, castle, findCastle, userBuilding, world, buildingLevel, buildingData, findUpgrade, isUpgrading, userResource, isEnoughResource, resourceUsed, index, resource, name_1;
                    ...
                    case 7:
                        ...
                        for (index = 0; index < userResource.length; index++) {
                            ...
                            workerChangeResource_1.CHANGE_RESOURCE.push({
                                ...
                                newValue: -findUpgrade[name_1],
                            });
                            resourceUsed += findUpgrade[name_1];
                        }
